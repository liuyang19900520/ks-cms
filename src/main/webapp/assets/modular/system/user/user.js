layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax'], function () {
    ...
    MgrUser.initColumn = function () {
        return [[
            ...
            {field: 'employeeNameCN', sort: true, title: '中文名'},
            {field: 'employeeNameJP', sort: true, title: '日文名'},
            {field: 'employeeNameKANA', sort: true, title: 'カナ'},
            {field: 'entryTime', sort: true, title: '入职时间'},
            {field: 'brithdate', sort: true, title: '出生日期'},
            {field: 'province', sort: true, title: '籍贯省份'},
